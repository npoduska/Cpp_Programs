...
void one::menul()
{
    ...
    cout<<"\n\n\n\t===============================\t\t\t============================\t\t\t\t======================================="<<endl;
    cout<<"\t[1] Veggie Supreme ($4.80)\t\t\t[2] Exotica Pizza($4.40)\t\t\t\t[3] Chicken Sizzler ($5.80)\n\t[4] Chrispy Chicken ($5.20)\t\t\t[5] Spaghetti ($3.50)\t\t\t\t\t[6] Country Feast ($4.00)\n\t[7] Tetrazzini ($4.20)\t\t\t\t[8] Double Cheese ($5.40)\t\t\t\t[9] Makizushi ($5.48)\n\t[10] Ham Burger ($3.90)\t\t\t[11] Margherita Pizza($5.25)\t\t\t\t[12] Fish 'n' Chips ($4.25)\n\t[13] Fajitas ($3.35)\t\t\t\t[14] Tempura ($3.24)\t\t\t\t\t[15] Hot Dog ($3.60)\n\t===========================\t\t\t==============================\t\t\t\t===========================\n\n\n\t\t\t\t\t\t\t\t[16] EXIT"<<endl;
